            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-300">hello@subodhstudio.com</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-300">@SubodhStudio</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-300">@subodh.studio</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-gray-300">Subodh Singh</div>
                </div>
              </div>
            </div>
          </div>
